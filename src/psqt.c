...
const int KingPSQT32[32] = {
    S(  80,-100), S(  90, -80), S(  35, -35), S(  25, -35),
    S(  65, -50), S(  55, -25), S(   5,   0), S( -15,   5),
    S(   0, -40), S(  40,   0), S(  15,  10), S( -20,  20),
    S( -50, -30), S(  25,   0), S(   0,  20), S( -30,  30),
    S( -20, -20), S( -15,   0), S(   0,  20), S( -30,  30),
    S( -20, -20), S( -15,   0), S( -15,  20), S( -25,  25),
    S( -20, -20), S( -30,   0), S( -35,   0), S( -30,   5),
    S( -80, -80), S( -60, -60), S( -35, -35), S( -35, -35),
};
