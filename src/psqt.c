...
const int PawnPSQT32[32] = {
    ...
    S( -15,   5), S(  16,  -2), S(   3,   0), S(   5,  -6),
    S( -21,   7), S(   0,   0), S(   0,  -5), S(   8, -15),
    S( -13,  15), S(   0,   5), S(  14, -10), S(  12, -24),
    S(  -2,  16), S(   8,   4), S(   5,  -3), S(  10, -23),
    S(   2,  23), S(   9,  21), S(  14,   1), S(  29, -21),
    S( -44,   3), S( -34,   5), S(   0, -18), S(   2, -29),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
};
...
const int KingPSQT32[32] = {
    S(  81,-105), S(  89, -82), S(  33, -32), S(  22, -38),
    S(  64, -49), S(  56, -39), S(   4,   2), S( -12,   9),
    S(   1, -41), S(  44, -25), S(  17,   5), S(  -9,  24),
    S( -52, -37), S(  33, -20), S(   2,  22), S( -44,  41),
    S( -19, -21), S(  53,  -4), S(   8,  31), S( -29,  39),
    S(  37, -23), S(  82,  -5), S(  73,  15), S(   8,  13),
    S(  14, -19), S(  49,  -6), S(  32,  -4), S(   6,  -2),
    S(  26, -81), S(  83, -68), S( -22, -35), S( -16, -36),
};
