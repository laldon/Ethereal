...
const int KnightPSQT32[32] = {
    ...
    S(   4, -23), S(  23, -19), S(  13,   1), S(  27,  11),
    S(   3,   5), S(  27,   7), S(  32,  30), S(  50,  32),
    S(  28,   5), S(  44,  12), S(  43,  39), S(  53,  43),
    S( -28,   8), S(  25,   4), S(  40,  36), S(  48,  32),
...
const int BishopPSQT32[32] = {
    ...
    S(  23, -11), S(  29, -12), S(  19,  -1), S(  20,   6),
    S(   8,  -5), S(  18,   0), S(  17,  12), S(  33,  17),
    S( -14,  11), S(  37,   3), S(   3,  15), S(  29,  18),
    S(  -1,   6), S(   0,   7), S(  25,   6), S(  20,   5),
...
const int RookPSQT32[32] = {
    ...
    S( -17, -19), S(   5, -14), S(  -4, -21), S(   0, -22),
    S( -17,  -1), S( -10,   4), S(  -3,   1), S(  -1,   2),
    S( -11,  12), S(  -9,  10), S(  15,   4), S(  20,   6),
    S( -16,  14), S(  15,   9), S(   9,  12), S(  17,  11),
...
const int QueenPSQT32[32] = {
    ...
    S(   5, -22), S(  23, -17), S(   5,   5), S(  -1,   0),
    S(   4,  -5), S(  10,   4), S(  -6,  14), S(  -4,  45),
    S( -10,  10), S( -13,  33), S(  -8,  21), S( -22,  51),
    S( -12,   3), S(  -5,  18), S(  -1,  20), S( -10,  45),
