...
const int PawnPSQT32[32] = {
    ...
    S(  -2,  11), S(  23,  -2), S(  13,  12), S(   0,  -2),
    S( -15,   6), S(   0,   0), S(   0,   3), S(  -2,  -4),
    S(  -7,  23), S(   2,  14), S(  28,  -1), S(  31, -15),
    S(   1,  28), S(   9,  16), S(  22,  11), S(  29, -11),
    S(   5,  34), S(  13,  30), S(  19,   8), S(  32, -14),
    S( -43,   9), S( -34,   9), S(  -1, -14), S(   2, -29),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
};
