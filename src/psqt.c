...
const int PawnPSQT32[32] = {
    ...
    S( -15,   3), S(  17,  -3), S(   4,  -1), S(   6,  -8),
    S( -20,   5), S(   1,   0), S(   0,  -7), S(   9, -16),
    S( -12,  14), S(   0,   4), S(  14, -11), S(  13, -25),
    S(  -1,  15), S(   9,   3), S(   6,  -5), S(  11, -24),
    S(   4,  21), S(  11,  18), S(  15,   0), S(  31, -24),
    S( -43,  -1), S( -34,   1), S(   1, -21), S(   5, -28),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
};
...
const int KingPSQT32[32] = {
    S(  79,-102), S(  87, -78), S(  31, -29), S(  19, -34),
    S(  62, -46), S(  56, -37), S(   4,   4), S( -12,  11),
    S(   4, -39), S(  45, -23), S(  17,   7), S(  -6,  25),
    S( -51, -37), S(  35, -18), S(   4,  24), S( -43,  43),
    S( -19, -22), S(  54,  -3), S(   9,  32), S( -28,  41),
    S(  36, -29), S(  82,  -8), S(  74,  13), S(   9,  11),
    S(  14, -22), S(  48, -10), S(  31, -11), S(   6,  -6),
    S(  26, -82), S(  83, -70), S( -22, -37), S( -16, -37),
};
