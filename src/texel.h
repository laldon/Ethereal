...
#define LEARNING    (   0.88) // Learning rate step size
#define REPORTING   (    250) // How often to report progress

#define NDEPTHS     (     18) // # of search iterations
#define NTERMS      (    172) // # of terms to tune
#define NPOSITIONS  (  10000) // # of FENs in book
