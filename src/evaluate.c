...
const int KingDefenders[12] = {
    S( -36, -15), S( -22,   2), S(  -1,   3), S(  12,  10), 
    S(  26,  -1), S(  40,   1), S(  32,  11), S(  23,   0), 
...
const int KingStorm[2][4][8] = {
  {{S(   2,   7), S(  34,  21), S(  -7,   7), S( -19,   0), S(   3,  -2), S(   0,  -5), S( -11,   1), S(   5,  11)},
   {S(   5,  27), S(  12,  20), S(  -7,   2), S(  -7,  -5), S(   8,  -1), S(  12,  -8), S(   2,   1), S(  -7,  19)},
   {S(   3,  19), S(   4,  24), S( -12,   6), S( -22,   0), S(  19,  -6), S(   4,  -4), S( -12,  -5), S(  14,  19)},
   {S(   5,  18), S(   6,  22), S(  -8,  -8), S( -38, -12), S( -22,  -5), S(   5, -14), S(   5,  -5), S( -22,  18)}},
  {{S(   0,   0), S(   0,   0), S(   3, -16), S(  31, -13), S(   9,   1), S(  -4,  -7), S(  -7,  -1), S(   0,   1)},
   {S(   0,   0), S(   0,   0), S(  -1, -23), S(  30,  -9), S(  -1,   1), S(  -4,   0), S(  -1,   0), S(  -2,   0)},
   {S(   0,   0), S(  -1,  -1), S(  -9, -22), S(  -4,  -4), S(  -7,   4), S( -20,  -4), S(  -4,  -1), S(   0,   0)},
   {S(   0,   0), S(   0,   0), S(  -9, -19), S(  -9,  -3), S( -13,  -6), S(  12, -11), S(  17,   1), S(   1,   1)}},
};
